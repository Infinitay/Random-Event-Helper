package randomeventsolver.randomevents.pinball;
...
public class PinballHelper
{
	...
	public void onChatMessage(ChatMessage chatMessage)
	{
		...
		{
			if (RandomEventSolverPlugin.isInRandomEventLocalInstance(this.client) && sanitizedChatMessage.equals("You may now leave the game area."))
			{
